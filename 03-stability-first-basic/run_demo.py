...
from src.data import get_split_mnist_loaders, build_replay_buffer_from_loader
...
def main():
    ...
    train_a, test_a, train_b, test_b = get_split_mnist_loaders(batch_size=cfg.batch_size)
